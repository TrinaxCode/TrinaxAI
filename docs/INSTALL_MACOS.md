<h1 align="center">
  ...
  <a href="https://www.trinaxai.app/">TrinaxAI</a> · 🍎 macOS Installation
</h1>
...
> Release status: `v1.2.0` is the current candidate, but its GitHub Release assets are not published yet. For immediate testing, use the local checkout with this tree; the installer intentionally refuses to fall back to `main`.

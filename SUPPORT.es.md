...
Incluye la salida con errores cuando reportes un fallo.
...
- Perfil de TrinaxAI: `medium`, `high` o `ultra`.
- Si usas solo localhost o también acceso por LAN o teléfono.

## Seguridad

No publiques tokens, documentos privados, capturas de pantalla con datos sensibles ni archivos personales. Para reportes de seguridad, consulta `SECURITY.md`.
